...
class LoadImagesAndLabels(Dataset):  # for training/testing
    ...
    def __getitem__(self, index):
        ...
        #camera parameters
        eye, camera_direction, camera_up = nmr.get_params(cam_trans, veh_trans) #因为数据集中的车辆不带旋转，只考虑了相机的位置和角度，相机的位置带了权重，可能是考虑了汽车正则化的原因
...
def load_image(self, index):
    ...
    sc=os.sep + 'differentColor' +os.sep+ '255,255,255'+os.sep
    ...
    img_path=sc.join(path.rsplit(sb, 1)).rsplit('.', 1)[0]+ '.png'
